...
s_tot = s_ras + s_bmp + s_png + s_tif + s_pgm + s_jpg + s_ppm + s_jpeg;

if s_tot < 1,
   fprintf(1,'No image in this directory in either ras, bmp, png, tif, pgm, ppm or jpg format. Change directory and try again.\n');
   return;
end;
...
while (Nima_valid==0),
   ...
   format_image = '0';
	...
	while format_image == '0',
   	...
   	format_image =  input('Image format: ([]=''r''=''ras'', ''b''=''bmp'', ''n''=''png'', ''t''=''tif'', ''p''=''pgm'', ''j''=''jpg'', ''m''=''ppm'') ','s');
